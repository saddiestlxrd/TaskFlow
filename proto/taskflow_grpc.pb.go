...
const (
	TaskService_CreateTask_FullMethodName = "/TaskFlow.TaskService/CreateTask"
	TaskService_GetTask_FullMethodName    = "/TaskFlow.TaskService/GetTask"
	TaskService_DeleteTask_FullMethodName = "/TaskFlow.TaskService/DeleteTask"
	TaskService_UpdateTask_FullMethodName = "/TaskFlow.TaskService/UpdateTask"
	TaskService_CreateUser_FullMethodName = "/TaskFlow.TaskService/CreateUser"
	TaskService_Login_FullMethodName      = "/TaskFlow.TaskService/Login"
	TaskService_GetUser_FullMethodName    = "/TaskFlow.TaskService/getUser"
)
...
func (c *taskServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskService_Login_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TaskService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_Login_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
